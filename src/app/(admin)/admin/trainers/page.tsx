        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            <h1 className="font-headline text-5xl md:text-7xl font-black text-white leading-none tracking-tighter uppercase mb-4">
              ENTRENADORES <span className="text-[#cafd00] italic">ÉLITE</span>
            </h1>
            <p className="text-white/60 font-body max-w-lg text-lg">
              Equipo técnico de Gym Power CDMX: especialidades, disponibilidad y seguimiento.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-[10px] font-black text-[#cafd00] uppercase tracking-[0.2em] flex items-center gap-2">
                      <span className="w-8 h-[1px] bg-[#cafd00]" /> Disponibilidad semanal
                    </h3>
                    {chips.length === 0 ? (
          ...
          <div className="bg-[#131313] p-6 md:col-span-2 flex flex-col">
            <div className="flex justify-between items-center mb-8">
              <h3 className="text-[10px] font-black text-[#cafd00] uppercase tracking-[0.2em] flex items-center gap-2">
                <span className="w-8 h-[1px] bg-[#cafd00]" /> Actividad reciente
              </h3>
              <span className="text-[10px] text-white/40 font-bold uppercase">Demo</span>
            </div>
            <div className="space-y-6">
              <div className="flex items-center justify-between border-b border-white/10 pb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-white font-medium">Marco Vega actualizó bloque del sábado</p>
                    <p className="text-[10px] text-white/40 uppercase font-bold">Hace 2 h</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between border-b border-white/10 pb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-white font-medium">Nuevo perfil: Sofía Luna</p>
                    <p className="text-[10px] text-white/40 uppercase font-bold">Ayer</p>
                  </div>
                </div>
                <span className="text-[11px] font-mono text-white/60">#SL-4412</span>
              </div>
            </div>
            <button type="button" className="mt-auto w-full py-4 text-center text-white/40 font-headline font-bold text-[10px] uppercase tracking-widest hover:text-white transition-colors">
              Ver más
            </button>
          </div>
        </div>
